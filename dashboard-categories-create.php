...
<html lang="en">
  <head>
    ...
    <title>Dashboard Category Baru | Toko Supplier Daging Ayam Segar</title>
          ...
          >
            <div class="container-fluid">
              <div class="dashboard-heading">
                <h2 class="dashboard-title">Create Categories</h2>
                <p class="dashboard-subtitle">Create your Categories product</p>
              </div>
