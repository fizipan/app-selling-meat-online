...
if (isset($_POST["konfirmasi"])) {
  if (konfirmasi($_POST) > 0) {
    header("Location: ?page=transactions-no-confim");
  }
}
                    ...
                    <table class="table table-striped table-hover" id="table">
                      ...
                      <tbody>
                        <?php 
                          ...
                          $query = "SELECT * FROM transactions INNER JOIN users ON transactions.user_id = users.id_user INNER JOIN rekening_numbers ON transactions.rekening_id = rekening_numbers.id_rekening WHERE transaction_status = 'BELUM KONFIRMASI'";
