...
<div class="section-content section-dashboard-home" data-aos="fade-up">
  <div class="container-fluid">
    <div class="dashboard-heading">
      ...
      <p class="dashboard-subtitle">Manage Your Users</p>
    </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <div class="row mb-4">
                <div class="col-12">
                <a href="?page=users-create" class="btn btn-success">
                  + Add New Users
                </a>
                </div>
              </div>
                            ...
                            <td style="width: 17%; text-align: center;">
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                  ...
                                  <a class="dropdown-item" onclick="return confirm('Apakah Ingin Menghapus <?= $user['name'] ?> ?')" href="?page=users-delete&id=<?= $user["id_user"]; ?>">Delete</a>
                                </div>
                              </div>
                            </td>
                          </tr>
