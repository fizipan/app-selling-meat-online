...
<html lang="en">
  <head>
    ...
    <title>Dashboard Product Baru | Toko Supplier Daging Ayam Segar</title>
          ...
          >
            <div class="container-fluid">
              <div class="dashboard-heading">
                <h2 class="dashboard-title">Create Galleries</h2>
                <p class="dashboard-subtitle">Create your Galleries product</p>
              </div>
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <select
                                  ...
                                  class="form-control"
                                >
                                  <option value="">Ayam Ceker Halus</option>
                                  <option value="">Paha Lembut</option>
                                  <option value="">Dada Besar</option>
                                </select>
                              </div>
                            </div>
                            <div class="col-md-12">
