...
>
  ...
  <div class="section-content section-dashboard-home" data-aos="fade-up">
    <div class="container-fluid">
      ...
      <?php 
        $transactionMain = query("SELECT * FROM transactions WHERE id_transaction = $idTransaction")[0];
      ?>
          ...
          <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="tel" readonly name="phone_number" id="phone_number" class="form-control form-store" value="<?= $user["phone_number"] ?? ''; ?>" required>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="zip_code">Kode Pos</label>
                <input type="number" readonly name="zip_code" id="zip_code" required value="<?= $user["postal_code"] ?? ''; ?>" class="form-control form-store">
              </div>
            </div>
            <div class="col-md-12" id="alamat">
              <div class="form-group">
                <label for="address">Alamat</label>
                <textarea name="address" readonly id="editor"><?= $user["address"] ?? ''; ?></textarea>
              </div>
            </div>
          </div>
          <div class="row" data-aos="fade-up" data-aos-delay="150">
